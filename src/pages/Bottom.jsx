...
const Bottom = () => {
  return (
    <div className='flex flex-col flex-wrap md:flex-row justify-start items-start md:items-center min-w-[360px]'>
      ...
      <div className='flex-[1] px-[2.5rem] py-[3.5rem] md:px-[1rem] lg:px-[2.5rem] md:py-[.2rem]'>
        <h2 className='uppercase text-black text-start text-[.8rem] lg:text-[] tracking-[.3rem] font-semibold'>
          About our furniture
        </h2>
        <p className='text-darkGray text-start mt-[1rem] md:mt-0 lg:mt-[.5rem] lg:text-[.9rem] text-[0.9rem] md:text-[.7rem] font-medium max-w-[24rem]'>
